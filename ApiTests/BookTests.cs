    ...
    public class BookTests : IDisposable
    {
        ...
        public void Test_GetAllBooks()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                foreach (var book in books)
                {
                    ...
                    Assert.That(book["category"], Is.Not.Null.And.Not.Empty, "Book category should not be null or empty");
        ...
        public void Test_GetBookByTitle()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(book["author"]?.ToString(), Is.EqualTo("F. Scott Fitzgerald"), "Book with author 'F. Scott Fitzgerald' doesn't exists");
        ...
        public void Test_AddBook()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(content["category"], Is.Not.Empty, "Book category should not be empty");
                Assert.That(content["category"]?["_id"]?.ToString(), Is.EqualTo(categoryId), $"Book category should be '{categoryId}'");
            });
        ...
        public void Test_UpdateBook()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(content["title"]?.ToString(), Is.EqualTo(title), "Book title should match the updated value");
                Assert.That(content["author"]?.ToString(), Is.EqualTo(author), "Book author should match the updated value");
            });
        }
