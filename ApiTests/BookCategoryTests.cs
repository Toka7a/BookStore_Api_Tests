...
namespace ApiTests
{
    ...
    public class BookCategoryTests : IDisposable
    {
        ...
        public void Test_BookCategoryLifecycle()
        {
            ...
            var categoryTitle = "Fictional Literature";
            ...
            Assert.That(createdCategory["title"]?.ToString(), Is.EqualTo(categoryTitle), "Category title should be 'Fictional Literature'");
            ...
            Assert.Multiple(() =>
            {
                ...
                var category = categories.FirstOrDefault(b => b["title"]?.ToString() == "Fictional Literature");
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(updatedCategory["title"]?.ToString(), Is.EqualTo(updatedCategoryTitle), "Expected the updated category title to match");
            });
